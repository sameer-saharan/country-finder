...
function CountryInfo() {
  ...
  return (
    <div className='h-screen'>
      <div className="flex flex-col items-center gap-5 bg-[#524444] rounded-xl p-5 text-white dark:bg-[#ffe6e6] dark:text-black">
        ...
        <div className="flex gap-x-1">
          ...
          {!country.borders ? "N/A" : ""}
          {country.borders &&
            country.borders.map((borderCont, index) => (
              <p key={index}>{borderCont}</p>
            ))}
        </div>
      </div>
    </div>
